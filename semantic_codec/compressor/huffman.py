...
class InstructionPartFrequencyChanger(object):
    ...
    def _change_parts(self, changer, get_parts, with_part, frequency):
        ...
        progress_bar = TextProgressBar(iteration=0, total=len(freq_sorted),
                                       prefix='Changing Frequence:',
                                       decimals=0, bar_length=50, print_dist=1)
            ...
            for j in range(0, len(with_part[part])):
                ...
                while not any_correct and index > part:
                    ...
                    for register_part in get_parts(encoding, part):
                        ...
                        encoding = changer(encoding, part, new_part, register_part)
                        ...
                        if correct_qos:
                            instruction = CAPSInstruction(encoding, instruction.address)
